    ...
    <div className="vstup">
        <div className="container">
            ...
            <div className="padd-block add-block">
                <p className="sub-main-text add-info tac">За додатковою інформацією, будь ласка, звертайтесь до розділу <Link className="vstup-link" to="/contacts">«Контакти»</Link> або завітайте на <Link className="vstup-link" to="/open-day">«День відкритих дверей»</Link></p>
            </div>
